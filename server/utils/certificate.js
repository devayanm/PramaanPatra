...
const certificate = async (data) => {
    ...
    <body>
        ...
        <div class="outer-container">
            ...
            <div class="certificate">
                ...
                <div class="m">Name: <b>${data.child_name}</b></div>
                <div class="m">Name of Father: <b>${data.child_father_name}</b></div>
                <div class="m">Name of Mother: <b>${data.child_mother_name}</b></div>
                <div class="m">Date of birth: <b>${data.birth_date}</b></div>
                <div class="m">Place of Birth: <b>${data.birth_location}</b></div>
                ...
                <a class="verify" target="_blank" href="http://localhost:3000/certificate/${data.issuedTo}/birth-certificate">VERIFY</a>
            </div>
            </div>
        </div>
        </div>
  ...
  const pdfPath = 'birth_certificate.pdf';
